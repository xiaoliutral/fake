...
public class FakeRedisCache : RedisCache, ICacheSupportsMultipleItems
{
    ...
    static FakeRedisCache()
    {
        var type = typeof(RedisCache);

        RedisDatabaseField = ThrowHelper.ThrowIfNull(type.GetField("_cache", BindingFlags.Instance | BindingFlags.NonPublic), nameof(RedisDatabaseField));

        ConnectMethod = ThrowHelper.ThrowIfNull(type.GetMethod("Connect", BindingFlags.Instance | BindingFlags.NonPublic), nameof(ConnectMethod));

        ConnectAsyncMethod = ThrowHelper.ThrowIfNull(type.GetMethod("ConnectAsync", BindingFlags.Instance | BindingFlags.NonPublic), nameof(ConnectAsyncMethod));

        MapMetadataMethod = ThrowHelper.ThrowIfNull(type.GetMethod("MapMetadata", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Static), nameof(MapMetadataMethod));

        GetAbsoluteExpirationMethod = ThrowHelper.ThrowIfNull(type.GetMethod("GetAbsoluteExpiration", BindingFlags.Static | BindingFlags.NonPublic), nameof(GetAbsoluteExpirationMethod));

        GetExpirationInSecondsMethod = ThrowHelper.ThrowIfNull(type.GetMethod("GetExpirationInSeconds", BindingFlags.Static | BindingFlags.NonPublic), nameof(GetExpirationInSecondsMethod));

        OnRedisErrorMethod = ThrowHelper.ThrowIfNull(type.GetMethod("OnRedisError", BindingFlags.Instance | BindingFlags.NonPublic), nameof(OnRedisErrorMethod));

        RecycleMethodInfo = ThrowHelper.ThrowIfNull(type.GetMethod("Recycle", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Static), nameof(RecycleMethodInfo));
    ...
    public FakeRedisCache(IOptions<RedisCacheOptions> optionsAccessor)
    ...
    {
        keys = ThrowHelper.ThrowIfNull(keys, nameof(keys));
