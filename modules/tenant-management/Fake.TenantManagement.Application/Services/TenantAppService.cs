...
public class TenantAppService(ITenantRepository tenantRepository, TenantManagerDomainService tenantManagerDomainService)
    : TenantManagementAppServiceBase
{
    public async Task<TenantPagedItem> GetAsync(Guid id)
    {
        ...
        if (existedTenant == null) throw new BusinessException(FakeTenantManagementDomainResource.TenantNotExists, id);
