  ...
  <div class="menu-page">
    ...
    >
      ...
      >
        ...
        <a-form-item v-if="formState.type === 0" label="图标" name="icon">
          <a-input v-model:value="formState.icon" placeholder="请输入图标名称" />
        </a-form-item>

        <a-form-item v-if="formState.type === 0" label="路由" name="route">
          <a-input v-model:value="formState.route" placeholder="请输入路由路径" />
        </a-form-item>

        <a-form-item v-if="formState.type === 0" label="组件" name="component">
        ...
        <a-form-item v-if="formState.type === 0" label="是否隐藏" name="isHidden">
          <a-switch v-model:checked="formState.isHidden" />
        </a-form-item>

        <a-form-item v-if="formState.type === 0" label="是否缓存" name="isCached">
